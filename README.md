...
A1: 确保所有节点网络互通，检查防火墙规则，确保 6443、2379、2380 等端口开放。

Q2: Ollama 模型拉取失败？

A2: 检查节点网络是否可以访问互联网，或者使用本地模型文件导入。

Q3: SRE Agent 无法访问 K8s API？

A3: 检查 ServiceAccount 和 RBAC 配置是否正确，确保 Agent 具有足够的权限。
